<template lang="pug">
  .inner-page
    .inner-page__panel
      ...
      .inner-page__navbar
        .tabs 
          a.tabs__item.tabs__item-active(href="#/" title="обо мне") Обо мне 
          a.tabs__item(href="#/" title="Работы") Работы
          a.tabs__item(href="#/" title="Отзывы") Отзывы
      ...
      .about-page
        .about-page__header
          ...
          .about-page__add-group
            button(type="button").basic-batton
